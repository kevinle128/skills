...
3. Activate `kevinle128-skills:fix --auto` with the exact failing command and error evidence.
...
- **Close a plan-backed change's index row.** Match this merged PR to a plan by
  ...
  section of `kits/core/skills/implement/references/plan-state-files-first.md`.
