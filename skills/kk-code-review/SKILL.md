...
**Process:**
1. Invoke `/kk:scout` with edge-case-focused prompt
...
**Typically follows:** `/kk:implement` (review after implementation), `/kk:fix` (review after bug fix)
**Typically precedes:** `the engineer ship skill` (ship after review passes)
**Related:** `/kk:scout` (scout before reviewing), `the installed test skill` (test before reviewing)
