...
Load for `/kevinle128-skills:docs agent-context`: author, audit, or optimize a project's
**root** agent context file (`CLAUDE.md` / `AGENTS.md`). For a subfolder context
file use `/kevinle128-skills:folder-context`; for human `docs/` use `init` or `update`.
