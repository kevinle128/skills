...
full operations, invoke `/kevinle128-skills:docs init`, `/kevinle128-skills:docs update`, `/kevinle128-skills:docs summarize`,
or `/kevinle128-skills:docs agent-context` (root `CLAUDE.md`/`AGENTS.md`).
...
- `/kevinle128-skills:implement` and `/kevinle128-skills:fix`: update docs during finalize only when the impact
  criteria above apply.
- The installed planning skill reads routed project context before creating an
  execution plan.
- `/kevinle128-skills:preview`: keep temporary visuals with the active plan; link them from
  evergreen docs only when they remain useful.
- `/kevinle128-skills:tech-graph`: use for publish-grade diagrams when a visual materially
