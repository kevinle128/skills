...
**Mandatory:** Activate `kevinle128-skills:scout` skill or, when delegation is permitted,
...
2. Activate `kevinle128-skills:debug` skill (systematic-debugging + root-cause-tracing).
3. Activate `kevinle128-skills:sequential-thinking` — structured hypothesis formation.
...
Activate `kevinle128-skills:brainstorm` skill.
...
Implement per plan. Use `kevinle128-skills:context-engineering`, `kevinle128-skills:sequential-thinking`, `kevinle128-skills:problem-solving`.
...
- Activate `kevinle128-skills:project-management` for task sync-back, plan status updates, and progress tracking
...
| 2 | `kevinle128-skills:debug`, `kevinle128-skills:sequential-thinking`, optional delegated Explore when permitted, (`kevinle128-skills:problem-solving` auto) |
| 3 | `researcher` via `delegate_agent` when permitted |
| 4 | `kevinle128-skills:brainstorm` |
| 5 | `planner` |
| 6 | `kevinle128-skills:problem-solving`, `kevinle128-skills:sequential-thinking`, `kevinle128-skills:context-engineering` |
...
| 9 | `kevinle128-skills:project-management`; docs/git delegation only when permitted |
