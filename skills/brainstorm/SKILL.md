...
- feature or documentation delivery: the installed plan skill, then `/kevinle128-skills:implement`;
- diagnosed bug: `/kevinle128-skills:fix`;
...
**Typically precedes:** the installed plan skill or `/kevinle128-skills:implement`.

**Bug path:** opening intent frame -> scout and debug -> solution brainstorm when
needed -> `/kevinle128-skills:fix`.
