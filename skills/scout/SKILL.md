...
**Typically precedes:** `the engineer debug skill` (debug after scouting), `/kevinle128-skills:fix` (fix after locating code), `the installed code-review skill` (scout edge cases before review)
**Related:** `the engineer debug skill` (investigate after scouting), `/kevinle128-skills:brainstorm` (explore after scouting)
