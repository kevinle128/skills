...
**Process:**
1. Invoke `/kevinle128-skills:scout` with edge-case-focused prompt
...
**Typically follows:** `/kevinle128-skills:implement` (review after implementation), `/kevinle128-skills:fix` (review after bug fix)
**Typically precedes:** `the engineer ship skill` (ship after review passes)
**Related:** `/kevinle128-skills:scout` (scout before reviewing), `the installed test skill` (test before reviewing)
