...
3. If no plan found → Ask user to specify path or run `/kevinle128-skills:plan` first
...
## Next Steps
Remind the user they can run `/kevinle128-skills:validate-plan {plan-directory-path}` before implementation.
When the user approves implementation, run `/kevinle128-skills:implement {ABSOLUTE_PATH_TO_PLAN_DIR}/plan.md`.
