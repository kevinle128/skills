...
4. **Implementation option:** `/kevinle128-skills:implement {absolute-plan-path}/plan.md`
...
2. Read repository instructions and follow documentation navigation to the relevant requirements, architecture, and standards; use `/kevinle128-skills:scout` when owning evidence is missing, ambiguous, or conflicts with source and tests
...
7. **Context reminder:** `/kevinle128-skills:implement {absolute-plan-path}/plan.md`
...
2. Follow repository instructions and documentation navigation to relevant authorities, verify them against current source and tests, and use `/kevinle128-skills:scout` across affected areas
...
8. Output the standard `/kevinle128-skills:implement {absolute-plan-path}/plan.md` reminder
...
7. **Context reminder:** `/kevinle128-skills:implement --parallel {absolute-plan-path}/plan.md`
...
**Invocation:** Run `/kevinle128-skills:plan red-team {plan-directory-path}`.
```
/kevinle128-skills:plan red-team {plan-directory-path}
```
...
| `auto` | Run `/kevinle128-skills:validate-plan {plan-directory-path}` |
| `off` | Skip validation |

**Invocation (when prompt mode, user says yes):** Run:
```
/kevinle128-skills:validate-plan {plan-directory-path}
```
...
| Mode | Cook Command |
|------|-----------------------------|
| fast | `/kevinle128-skills:implement {path}/plan.md` |
| hard | `/kevinle128-skills:implement {path}/plan.md` |
| deep | `/kevinle128-skills:implement {path}/plan.md` |
| parallel | `/kevinle128-skills:implement --parallel {path}/plan.md` |
| two | `/kevinle128-skills:implement {path}/plan.md` |

If planning ran with `--tdd`, append `--tdd` to the reminder above so cook keeps
the tests-first execution path. Example:
`/kevinle128-skills:implement {path}/plan.md --tdd`
