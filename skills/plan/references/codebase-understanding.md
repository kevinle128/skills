...
- Use `/kevinle128-skills:scout ext` (preferred) or `/kevinle128-skills:scout` (fallback) skill invocation to search the codebase for files needed to complete the task
