...
Handled by **kk:implement** skill. Bootstrap-specific notes:
...
- Asset pipeline: `kk:ai-multimodal` (generate/analyze) → `imagemagick` (crop/resize) → background removal if needed
