...
4. If no logo provided: generate with `kk:ai-multimodal` skill
5. Screenshot wireframes with `kk:agent-browser` -> save to `./docs/wireframes/`
...
Activate **kk:plan** skill: `/kk:plan --hard <requirements>`
...
Activate **kk:implement** skill: `/kk:implement <plan-path>` (interactive mode — review gates at each step)
