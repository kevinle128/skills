...
For presentation-grade output, consider invoking `/kk:ui-ux-pro-max` for richer style selection and distinctive font/palette pairing.
...
**AI image generation:** If `/kk:ai-multimodal` skill is available, use it to generate images for the deck. For any deck over 10 slides, target a minimum of 2–4 images. Priority order:
...
```bash
# Use /kk:ai-multimodal skill for image generation if needed
