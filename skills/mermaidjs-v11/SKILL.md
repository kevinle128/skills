...
For universal SVG layout rules when reviewing rendered output for collisions or unreadable labels, load `/kevinle128-skills:tech-graph` and apply its component spacing, arrow routing, label placement, and z-index ordering guidance.
