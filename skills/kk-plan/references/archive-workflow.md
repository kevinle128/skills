...
### Step 2: Summarize the plans and document them with `/kk:journal` skill invocation
...
- Stage and commit the changes (Use `/kk:git` for commit flow)
- Commit and push the changes (Use `/kk:git` for push flow)
