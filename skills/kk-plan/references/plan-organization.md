...
3. **Fill content sections** in plan.md via edit-file capability:
   ...
   - `## Runtime Flow Proof` — one complete proof row per promised feature
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sign in | User | Submit the sign-in form | Registered browser route and API endpoint | Browser → API → authentication service → session store | Authenticated session and account page | Open the application, sign in, and assert the account page and session | Identity provider | Registered test account | PASSED |
...
**Runtime Flow**
- Actor and real trigger
- Registered entry point
- Ordered path through internal owners
- Prepared data and third-party mocks
- Observable result
- Same-boundary end-to-end test
