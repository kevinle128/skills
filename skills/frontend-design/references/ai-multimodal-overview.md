...
Entry point for using the `kevinle128-skills:ai-multimodal` skill to generate and analyze visual assets that align with frontend design thinking and aesthetic guidelines.

## When to Use

Use `kevinle128-skills:ai-multimodal` in frontend design when you need to:
...
Use `aesthetic` for overall design system guidance and quality evaluation framework. Then use `kevinle128-skills:frontend-design` with `kevinle128-skills:ai-multimodal` for asset generation and analysis that follows those guidelines.

### With `kevinle128-skills:agent-browser`
Use `kevinle128-skills:agent-browser` to capture screenshots from inspiration websites for design extraction. Capture at actual viewport size, not full-page scrolls.
...
### With `kevinle128-skills:media-processing` Skill
