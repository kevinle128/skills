...
## Prerequisites
- Activate `kevinle128-skills:ui-ux-pro-max` skill first for design intelligence
- Have `kevinle128-skills:ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `kevinle128-skills:ai-multimodal` skill to extract:
...
### 4. Generate Assets
Use `kevinle128-skills:ai-multimodal` skill:
- Generate images, icons, backgrounds
- Verify generated assets match design
- Remove backgrounds if needed with `kevinle128-skills:media-processing`
