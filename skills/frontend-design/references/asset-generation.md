...
Complete workflow for generating design-aligned visual assets using `kevinle128-skills:ai-multimodal` skill.
...
Use `kevinle128-skills:ai-multimodal` skill's image generation capabilities:
...
Use `kevinle128-skills:ai-multimodal` to analyze the generated asset (see `visual-analysis.md` for complete workflow):
...
4. Consider using `kevinle128-skills:media-processing` skill for post-generation adjustments
