...
- Have `kevinle128-skills:ai-multimodal` skill ready for video analysis

## Workflow Steps

### 1. Analyze Video Details
Use `kevinle128-skills:ai-multimodal` skill to describe:
...
- Use `kevinle128-skills:media-processing` for processing
