...
1. **Analyze** with `kevinle128-skills:ai-multimodal` skill - extract colors, fonts, spacing, effects
...
**Assets**: Generate images with `kevinle128-skills:ai-multimodal`, process with `kevinle128-skills:media-processing`
