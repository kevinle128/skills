...
Browser-based visual testing via `kevinle128-skills:agent-browser`, `kevinle128-skills:chrome-profile`, `kevinle128-skills:web-testing`, or project-native Playwright/Vitest/k6 commands. Covers screenshots, responsive checks, accessibility audits, form automation, and console error collection.
...
6. For frontend: run UI tests via `kevinle128-skills:agent-browser`, `kevinle128-skills:chrome-profile`, `kevinle128-skills:web-testing`, or project-native browser tests
...
- **Browser**: `kevinle128-skills:agent-browser` for live browser interaction without real user cookies; `kevinle128-skills:chrome-profile` for the user's actual Chrome login state, opened with `chrome-profile open --json` and bound by the returned selector; `kevinle128-skills:web-testing` or project-native Playwright/Vitest/k6 for repeatable UI tests
- **Analysis**: `kevinle128-skills:ai-multimodal` skill for screenshot analysis
- **Debugging**: `kevinle128-skills:debug` skill when tests reveal bugs requiring investigation
- **Thinking**: `kevinle128-skills:sequential-thinking` skill for complex test failure analysis
...
**Typically follows:** `/kevinle128-skills:implement` (test after implementation), `/kevinle128-skills:fix` (test after bug fix)
**Typically precedes:** `the installed code-review skill` (review after tests pass)
**Related:** `/kevinle128-skills:implement` (implement then test), `/kevinle128-skills:fix` (fix then test)
