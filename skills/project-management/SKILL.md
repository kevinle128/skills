...
- `kevinle128-skills:plan` — Creates implementation plans (planning phase)
- `kevinle128-skills:implement` — Implements plans (execution phase, invokes project-manager at finalize)
