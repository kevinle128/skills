...
Standard patterns for spawning and using subagents in implementation workflows.
...
```
- Use `/kevinle128-skills:scout ext` (preferred) or `/kevinle128-skills:scout` (fallback)
