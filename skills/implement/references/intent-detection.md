...
```
"/kevinle128-skills:implement implement user auth --interactive"
→ Mode: interactive (explicit flag, stops at review gates)

"/kevinle128-skills:implement implement user auth"
→ Mode: interactive (default, stops at review gates)

"/kevinle128-skills:implement <plan-dir>/phase-02-api.md"
→ Mode: code (path detected, stops at review gates)

"/kevinle128-skills:implement quick fix for the login bug"
→ Mode: fast ("quick" keyword, stops at review gates)

"/kevinle128-skills:implement implement auth, payments, notifications, shipping"
→ Mode: parallel (4 features, stops at review gates)

"/kevinle128-skills:implement implement dashboard --fast"
...
"/kevinle128-skills:implement implement everything --auto"
→ Mode: auto (NO STOPS, implements all phases continuously)

"/kevinle128-skills:implement implement dashboard trust me"
