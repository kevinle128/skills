...
Used by `kevinle128-skills:review-pr` for human-facing GitHub prose.
...
- PR description headings and prose
- Review Summary / Risk / Findings / Verdict / handoff text (`kevinle128-skills:review-pr`)
