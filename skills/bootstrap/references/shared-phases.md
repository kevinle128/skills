...
Handled by **kevinle128-skills:implement** skill. Bootstrap-specific notes:
...
- Asset pipeline: `kevinle128-skills:ai-multimodal` (generate/analyze) → `imagemagick` (crop/resize) → background removal if needed
