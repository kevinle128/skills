...
2. Use `ui-ux-designer` + `researcher` subagents in parallel:
   ...
   - Describe assets for `kevinle128-skills:ai-multimodal` skill generation
...
4. If no logo provided: generate with `kevinle128-skills:ai-multimodal` skill
5. Screenshot wireframes with `kevinle128-skills:agent-browser` -> save to `./docs/wireframes/`
...
Activate **kevinle128-skills:plan** skill: `/kevinle128-skills:plan --hard <requirements>`
...
Activate **kevinle128-skills:implement** skill: `/kevinle128-skills:implement <plan-path>` (interactive mode — review gates at each step)
