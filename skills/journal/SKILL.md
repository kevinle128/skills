...
**Typically follows:** `/kevinle128-skills:implement` (journal after implementation), `/kevinle128-skills:fix` (journal after bug fix), or `/kevinle128-skills:git` (journal after delivery)
...
Explicit `/kevinle128-skills:journal` and `ak journal create` are always available and are
unaffected by any preference or flag.

The **automatic** journal step at the end of the `kevinle128-skills:plan`, `/kevinle128-skills:implement`,
`/kevinle128-skills:fix`, and `kevinle128-skills:bootstrap` skills honors:
...
that yourself first — invoke the installed ak-design/kk-frontend-design
