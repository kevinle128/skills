...
- `kk:plan` — Creates implementation plans (planning phase)
- `kk:implement` — Implements plans (execution phase, invokes project-manager at finalize)
