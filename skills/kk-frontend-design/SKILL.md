...
1. **Analyze** with `kk:ai-multimodal` skill - extract colors, fonts, spacing, effects
...
**Assets**: Generate images with `kk:ai-multimodal`, process with `kk:media-processing`
