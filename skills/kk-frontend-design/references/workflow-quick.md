...
python3 ${CLAUDE_PLUGIN_ROOT}/skills/kk-ui-ux-pro-max/scripts/search.py "<style-keywords>" --domain style
python3 ${CLAUDE_PLUGIN_ROOT}/skills/kk-ui-ux-pro-max/scripts/search.py "<mood>" --domain typography
python3 ${CLAUDE_PLUGIN_ROOT}/skills/kk-ui-ux-pro-max/scripts/search.py "<industry>" --domain color
```
...
### 3. Generate Assets
Use `kk:ai-multimodal` skill:
- Generate required visuals
- Verify quality quickly
- Use `kk:media-processing` for adjustments
