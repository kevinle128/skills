...
### View Mode
- `/kevinle128-skills:preview <file.md>` - View markdown file in novel-reader UI
- `/kevinle128-skills:preview <directory/>` - Browse directory contents
- `/kevinle128-skills:preview --stop` - Stop running server

### Generation Mode (Markdown)
- `/kevinle128-skills:preview --explain <topic>` - Generate visual explanation (ASCII + Mermaid + prose)
- `/kevinle128-skills:preview --slides <topic>` - Generate presentation slides (one concept per slide)
- `/kevinle128-skills:preview --diagram <topic>` - Generate focused diagram (ASCII + Mermaid)
- `/kevinle128-skills:preview --ascii <topic>` - Generate ASCII-only diagram (terminal-friendly)

### Generation Mode (HTML)
- `/kevinle128-skills:preview --html --explain <topic>` - Self-contained HTML explanation
- `/kevinle128-skills:preview --html --slides <topic>` - Magazine-quality HTML slide deck
- `/kevinle128-skills:preview --html --diagram <topic>` - HTML diagram with zoom controls
- `/kevinle128-skills:preview --html --diff [ref]` - Visual diff review
- `/kevinle128-skills:preview --html --plan-review [plan-file]` - Plan vs codebase comparison
- `/kevinle128-skills:preview --html --recap [timeframe]` - Project context snapshot
...
| Flag without topic | Ask user: "Please provide a topic: `/kevinle128-skills:preview --explain <topic>`" |
...
| Server startup failure | Check if port in use, try `/kevinle128-skills:preview --stop` first |
...
Use `/kevinle128-skills:mermaidjs-v11` skill for Mermaid syntax validation.
...
- For `--slides`: consider invoking `/kevinle128-skills:ui-ux-pro-max` for richer style selection
