...
```
"/kk:implement implement user auth --interactive"
→ Mode: interactive (explicit flag, stops at review gates)

"/kk:implement implement user auth"
→ Mode: interactive (default, stops at review gates)

"/kk:implement <plan-dir>/phase-02-api.md"
→ Mode: code (path detected, stops at review gates)

"/kk:implement quick fix for the login bug"
→ Mode: fast ("quick" keyword, stops at review gates)

"/kk:implement implement auth, payments, notifications, shipping"
→ Mode: parallel (4 features, stops at review gates)

"/kk:implement implement dashboard --fast"
...
"/kk:implement implement everything --auto"
→ Mode: auto (NO STOPS, implements all phases continuously)

"/kk:implement implement dashboard trust me"
