...
- Use `/kevinle128-skills:scout` or `/kevinle128-skills:scout ext` to find relevant files whenever context is missing or conflicting
- Use `kevinle128-skills:repomix` only when a broad packaged snapshot materially improves the investigation; do not generate a mandatory summary document
- Use `kevinle128-skills:docs-seeker` skill for package/plugin documentation
