...
For universal SVG layout rules when reviewing rendered output for collisions or unreadable labels, load `/kk:tech-graph` and apply its component spacing, arrow routing, label placement, and z-index ordering guidance.
