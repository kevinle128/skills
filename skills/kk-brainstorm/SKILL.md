...
- feature or documentation delivery: the installed plan skill, then `/kk:implement`;
- diagnosed bug: `/kk:fix`;
...
**Typically precedes:** the installed plan skill or `/kk:implement`.
