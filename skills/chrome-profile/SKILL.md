...
This is not the default for ordinary browser testing. Use `kevinle128-skills:agent-browser` when a fresh or tool-managed browser is enough. Use project-native Playwright or `kevinle128-skills:web-testing` for repeatable CI tests. Use this skill when the user's actual Chrome profile state matters.
